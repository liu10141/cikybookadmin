  ...
  methods: {
    ...
    subAddData() {
      switch (this.formType) {
        case 1:
          addShelfClass(this.form).then(res => {
            this.$message({
              message: "提交成功",
              type: "success"
            });
          ...
          break;
        case 2:
          editShelfClass(this.form).then(res => {
            this.$message({
              message: "提交成功",
              type: "success"
            });
    ...
    handleModifyStatus(id, status) {
      ...
      editShelfClassStatus(data).then(() => {
        this.$notify({
          title: "Success",
          message: "操作成功",
          type: "success",
    ...
    // 删除照片
    handleDel(id) {
      this.$confirm("此操作将删除此书架, 是否继续?", "提示", {
    ...
    getList() {
      ...
      getShelfClass(this.listQuery).then(response => {
