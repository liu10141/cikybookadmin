  ...
  <div class="app-container">
    ...
    <el-card>
      <el-form :inline="true" :model="listQuery" label-width="80px" class="demo-form-inline">
        ...
        <el-form-item label="活动标题:">
          <el-input v-model="listQuery.title" placeholder="请输入站点标题"></el-input>
        </el-form-item>
    ...
    <el-card style="margin-top: 20px">
      ...
      >
        ...
        <el-table-column label="活动简介" align="center">
          <template slot-scope="{ row }">
    ...
    />
    <!-- 导入地点 -->
    <el-dialog title="活动活动信息" :visible.sync="dialogFormVisible" center top="5vh" width="40%">
      <el-form :model="form" label-width="100px" ref="formName">
        ...
        <el-form-item label="活动标题:">
          <el-input v-model="form.title" placeholder="请输入网站标题"></el-input>
        </el-form-item>
        <el-form-item label="活动链接:">
          <el-input v-model="form.url" placeholder="请输入活动链接"></el-input>
        </el-form-item>
...
<script>
import { getWwq, delWwq, setWwqStatus, addWwq, editWwq } from '@/api/wwq'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getWwq(this.listQuery).then(response => {
